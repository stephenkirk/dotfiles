...
ln -s ~/dotfiles/vscode_settings.json ~/Library/Application\ Support/VSCodium/User/settings.json
ln -s ~/dotfiles/vscode_keybindings.json ~/Library/Application\ Support/VSCodium/User/keybindings.json
